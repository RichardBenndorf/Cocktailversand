...
* SWFA-1: Das System muss alle Cocktail-, Bestell- und Kundendaten persistent speichern
* SWFA-2: Das System muss sicherstellen, dass nur der jeweilige Kunde die Berechtigung hat,
seine Daten einsehen und bearbeiten zu können.
* SWFA-3: Das System muss die korrekten und vollständigen Daten zu der Bestellung, wie z. B.
die Zutaten und Menge zu erfassen
* NFAU-5: Der Kunde sollte maximal 10 Klicks bis zur Bestellaufgabe, maximal 5 Klicks bei
Standardcocktails benötigen.
* NFAP-1: Das Softwaresystem soll einen Wechsel von Website zu Website in maximal 3
...
1. Security SWAF2. (analyse zustand)
Designzustände:
* Nutzername Passwort 
* IP-Filter
* Link in Mail der Bestellbestätigung 

2. Localization / Internationalization NFAS-1
framework wählen
Oberflächen/Inhaltssprache 

3. SWFA-1 Resource Management


4. SWFA-1 Memory Management

5. SWAF-1 Persistence

6. Information Exchange use-case Bestellabwicklung
