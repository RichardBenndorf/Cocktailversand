...
|Barbetreiber |Eigentümer der Bar	| Auftraggeber stellt Anforderungen an den online-Shop
|Privatkunden | Kunden die für Partys oder Geschenke bestellen | Es darf nivht für gewerbliche Zwecke eingekauft werden
|Angestellte | | 
|Gesetzgeber | |
